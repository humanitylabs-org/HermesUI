...
def test_status_group_assets_have_matching_cache_identity():
    ...
    js_suffix = "&tab-polish=v1&status-groups=v1&new-session-divider=v2&status-indicators=v1&blank-draft-working=v1&contained-cron-replies=v1&hidden-cron-project=v1&performance-cache=v1&mobile-folder-dock=v1"
