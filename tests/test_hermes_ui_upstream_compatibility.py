...
def test_previously_uncovered_replacements_have_dedicated_contract_tests():
    ...
    expected = {
        "tests/test_css_tooltips.py::TestIndexHTMLTooltipCoverage::test_rail_btn_has_tooltip_class",
        "tests/test_css_tooltips.py::RailTooltipCascadeTests::test_all_rail_buttons_carry_has_tooltip",
        ...
        "tests/test_sidebar_collapse_toggle.py::TestRailButtonsPassFromRailClick::test_all_rail_buttons_pass_from_rail_click",
    }
