...
def render(repo_root: Path, home: Path, host: str, port: int) -> str:
...
Environment={quoted('HERMES_WEBUI_COOKIE_PATH=/hermesUI')}
...
def main() -> int:
    ...
    try:
        expected = render(args.repo_root, args.home, args.host, args.port)
