...
const SHELL_ASSETS = [
  './static/style.css' + VQ + '&overlay=wizard-canvas-v8&cron-notifications=v9&high-signal-model=v2&high-signal-layout=v1&high-signal-mode=v1&shell-theme=v1&session-status-groups=v1&private-app-rail=v1&new-session-divider=v2&opus-polish=v1&new-session-emphasis=v1&high-signal-toggle=v1&mobile-session-home=v1&notification-operations=v2&mobile-rail-right=v1&rail-selection-ring=v1',
  ...
  './static/tailnet-app-rail.js' + VQ + '&overlay=wizard-canvas-v8&bookmark-fallback=v5&bookmark-sync=v1&cron-notifications=v7&shell-theme=v1&private-only=v1&mobile-session-home=v1&cron-operations=v2&mobile-rail-right=v1',
  './static/tailnet-app-manager.js' + VQ + '&cron-notifications=v3&semantic-icons=v1',
  './static/panels.js' + VQ + '&cron-notifications=v3&high-signal-model=v1&cron-modal=v1',
