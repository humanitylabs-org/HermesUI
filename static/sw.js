...
// HermesUI frontend delivery marker: wizard-canvas-v6. This intentionally
...
const SHELL_ASSETS = [
  './static/style.css' + VQ + '&overlay=wizard-canvas-v6&cron-notifications=v7&high-signal-model=v2',
  './static/pwa-startup.js' + VQ,
  './static/boot.js' + VQ + '&tab-polish=v1',
  './static/assistant_turn_anchors.js' + VQ,
  './static/ui.js' + VQ + '&tab-polish=v1',
  './static/messages.js' + VQ + '&tab-polish=v1',
  './static/sessions.js' + VQ + '&tab-polish=v1',
  './static/session-swipe-navigation.js' + VQ,
  './static/tailnet-app-rail.js' + VQ + '&overlay=wizard-canvas-v6&bookmark-fallback=v5&bookmark-sync=v1&cron-notifications=v5',
  ...
  './static/session-dashboard.js' + VQ + '&tab-polish=v1&high-signal-model=v4',
