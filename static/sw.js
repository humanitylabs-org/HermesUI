...
const SHELL_ASSETS = [
  './static/style.css' + VQ + '&overlay=wizard-canvas-v6&cron-notifications=v8&high-signal-model=v2',
  ...
  './static/tailnet-app-rail.js' + VQ + '&overlay=wizard-canvas-v6&bookmark-fallback=v5&bookmark-sync=v1&cron-notifications=v6',
