...
const SHELL_ASSETS = [
  ...
  './static/tailnet-app-manager.js' + VQ + '&cron-notifications=v3&semantic-icons=v1&mobile-layer-nav=v1',
  './static/mobile-layer-navigation.js' + VQ + '&mobile-layer-nav=v1',
