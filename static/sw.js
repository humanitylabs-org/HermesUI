...
// HermesUI frontend delivery marker: wizard-canvas-v1. This intentionally
...
const SHELL_ASSETS = [
  './static/style.css' + VQ + '&overlay=wizard-canvas-v1',
  ...
  './static/tailnet-app-rail.js' + VQ + '&overlay=wizard-canvas-v1',
