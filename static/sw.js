...
const SHELL_ASSETS = [
  ...
  './static/session-dashboard.js' + VQ + '&tab-polish=v1&high-signal-model=v6&high-signal-history=v1&background-resume=v1&mode-rail=v1&summary-trust=v1&high-signal-toggle=v1&semantic-turns=v1',
