...
// HermesUI frontend delivery marker: wizard-canvas-v9. This intentionally
...
const SHELL_ASSETS = [
  './static/style.css' + VQ + '&overlay=wizard-canvas-v9&cron-notifications=v9&high-signal-model=v2&high-signal-layout=v1&high-signal-mode=v1&shell-theme=v1&session-status-groups=v1&private-app-rail=v1&new-session-divider=v2&opus-polish=v1&new-session-emphasis=v1&high-signal-toggle=v1&mobile-session-home=v1&notification-operations=v3&mobile-rail-right=v1&rail-selection-ring=v1&human-cron=v1&active-frequency=v1&scheduled-dashboard=v1&mobile-utility-menu=v1&mobile-bottom-menu=v1&mobile-collapsible-rail=v1&mobile-modern-nav=v1&notification-hierarchy=v1&notification-reply-indicators=v1&mobile-folder-dock=v2&folder-pill-colors=v1&mobile-tabs-removed=v1&mobile-toggle-switches=v1&voice-notes=v1&mobile-folder-quiet=v2&mobile-titlebar=v1&mobile-layer-nav=v7',
