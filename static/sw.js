...
const SHELL_ASSETS = [
  ...
  './static/message_projection.js' + VQ + '&semantic-turns=v2&multimodal-display=v4',
  './static/ui.js' + VQ + '&tab-polish=v1&recovery-filter=v2&background-resume=v1&classic-duration=v1&voice-notes=v1&semantic-turns=v2&transcript-disclosures=v1&thread-signal=v1&multimodal-display=v4',
