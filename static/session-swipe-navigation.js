...
(function(){
  ...
  function loadingSkeletonMarkup(){
    return '<span class="sr-only">Loading session content</span>'
      ...
      +'<article class="session-switch-skeleton-pane"><span class="session-switch-skeleton-pane-label">Last prompt</span><span class="session-switch-skeleton-line session-switch-skeleton-line--wide"></span><span class="session-switch-skeleton-line session-switch-skeleton-line--short"></span></article>'
