...
ή κρατήστε πατημένο το Alt και κάντε κλικ για να προσθέσετε νέα σημεία`,placeImage:`Κάντε κλικ για να τοποθετήσετε την εικόνα ή κάντε κλικ και σύρετε για να ορίσετε το μέγεθός της χειροκίνητα`,publishLibrary:`Δημοσιεύστε τη δική σας βιβλιοθήκη`,bindTextToElement:`Πατήστε Enter για προσθήκη κειμένου`,deepBoxSelect:`Κρατήστε πατημένο το CtrlOrCmd για να επιλέξετε βαθιά, και να αποτρέψετε τη μεταφορά`,eraserRevert:`Κρατήστε πατημένο το Alt για να επαναφέρετε τα στοιχεία που σημειώθηκαν για διαγραφή`,firefox_clipboard_write:`Αυτή η επιλογή μπορεί πιθανώς να ενεργοποιηθεί αλλάζοντας την ρύθμιση "dom.events.asyncClipboard.clipboardItem" σε "true". Για να αλλάξετε τις ρυθμίσεις του προγράμματος περιήγησης στο Firefox, επισκεφθείτε τη σελίδα "about:config".`,disableSnapping:``},c={cannotShowPreview:`Αδυναμία εμφάνισης προεπισκόπησης`,canvasTooBig:`Ο καμβάς μπορεί να είναι μεγάλος.`,canvasTooBigTip:`Συμβουλή: προσπαθήστε να μετακινήσετε τα πιο απομακρυσμένα στοιχεία λίγο πιο κοντά μαζί.`},l={headingMain:`Συνέβη κάποιο σφάλμα. Προσπάθησε <button>φόρτωσε ξανά την σελίδα.</button>`,clearCanvasMessage:`Εάν το παραπάνω δεν δουλέψει, προσπάθησε <button>καθαρίσετε τον κανβά.</button>`,clearCanvasCaveat:` Αυτό θα προκαλέσει απώλεια της δουλειάς σου `,trackedToSentry:`Το σφάλμα με αναγνωριστικό {{eventId}} παρακολουθήθηκε στο σύστημά μας.`,openIssueMessage:`Ήμασταν πολύ προσεκτικοί για να μην συμπεριλάβουμε τις πληροφορίες της σκηνής σου στο σφάλμα. Αν η σκηνή σου δεν είναι ιδιωτική, παρακαλώ σκέψου να ακολουθήσεις το δικό μας <button>ανιχνευτής σφαλμάτων.</button> Παρακαλώ να συμπεριλάβετε τις παρακάτω πληροφορίες, αντιγράφοντας και επικολλώντας το ζήτημα στο GitHub.`,sceneContent:`Περιεχόμενο σκηνής:`},u={desc_intro:`Μπορείς να προσκαλέσεις άλλους να δουλέψουν μαζί σου.`,desc_privacy:`Μην ανησυχείς, η συνεδρία χρησιμοποιεί κρυπτογράφηση από σημείο σε σημείο, άρα οτιδήποτε κάνεις θα παραμείνει ανοιχτό μόνο σε εσένα. Ούτε οι μηχανές μας μπορούν να δουν τι κάνεις.`,button_startSession:`Έναρξη Συνεδρίας`,button_stopSession:`Τερματισμός Συνεδρίας`,desc_inProgressIntro:`Η ζωντανή συνεργασία με άλλους είναι σε ενεργή.`,desc_shareLink:`Μοιραστείτε τον σύνδεσμο με όποιον θέλετε να δουλέψετε μαζί:`,desc_exitSession:`Η διακοπή θα σας αποσυνδέσει από το δωμάτιο, αλλά θα μπορείτε να συνεχίσετε να δουλεύετε στον πίνακα, τοπικά. Σημειώσατε ότι αυτό δεν θα επηρεάσει τον πίνακα άλλων, και θα μπορούν ακόμα να συνεισφέρουν στην δική τους έκδοση.`,shareTitle:`Συμμετάσχετε σε μια ζωντανή συνεδρία συνεργασίας για το Excalidraw`},d={title:`Σφάλμα`},f={disk_title:`Αποθήκευση στο δίσκο`,disk_details:`Εξαγωγή δεδομένων σκηνής σε ένα αρχείο από το οποίο μπορείτε να εισάγετε αργότερα.`,disk_button:`Αποθήκευση σε αρχείο`,link_title:`Κοινόχρηστος σύνδεσμος`,link_details:`Εξαγωγή ως σύνδεσμο μόνο για ανάγνωση.`,link_button:`Εξαγωγή σε Σύνδεση`,excalidrawplus_description:`Αποθηκεύστε τη σκηνή στο χώρο εργασίας σας Excalidraw+.`,excalidrawplus_button:`Εξαγωγή`,excalidrawplus_exportError:`Δεν ήταν δυνατή η εξαγωγή στο Excalidraw+ αυτή τη στιγμή...`},p={blog:`Διαβάστε το Blog μας`,click:`κλικ`,deepSelect:`Βαθιά επιλογή`,deepBoxSelect:`Βαθιά επιλογή μέσα στο πλαίσιο και αποτροπή συρσίματος`,curvedArrow:`Κυρτό βέλος`,curvedLine:`Κυρτή γραμμή`,documentation:`Εγχειρίδιο`,doubleClick:`διπλό κλικ`,drag:`σύρε`,editor:`Επεξεργαστής`,editLineArrowPoints:``,editText:``,github:`Βρήκατε πρόβλημα; Υποβάλετε το`,howto:`Ακολουθήστε τους οδηγούς μας`,or:`ή`,preventBinding:`Αποτροπή δέσμευσης βέλων`,tools:`Εργαλεία`,shortcuts:`Συντομεύσεις πληκτρολογίου`,textFinish:`Ολοκλήρωση επεξεργασίας (επεξεργαστής κειμένου)`,textNewLine:`Προσθήκη νέας γραμμής (επεξεργαστής κειμένου)`,title:`Βοήθεια`,view:`Προβολή`,zoomToFit:`Zoom ώστε να χωρέσουν όλα τα στοιχεία`,zoomToSelection:`Ζουμ στην επιλογή`,toggleElementLock:`Κλείδωμα/Ξεκλείδωμα επιλογής`,movePageUpDown:`Μετακίνηση σελίδας πάνω/κάτω`,movePageLeftRight:`Μετακίνηση σελίδας αριστερά/δεξιά`},m={title:`Καθαρισμός καμβά`},h={title:`Δημοσίευση βιβλιοθήκης`,itemName:`Όνομα αντικειμένου`,authorName:`Όνομα δημιουργού`,githubUsername:`GitHub username`,twitterUsername:`Twitter username`,libraryName:`Όνομα βιβλιοθήκης`,libraryDesc:`Περιγραφή βιβλιοθήκης`,website:`Ιστοσελίδα`,placeholder:{authorName:`Όνομα ή όνομα χρήστη`,libraryName:`Όνομα της βιβλιοθήκης σας`,libraryDesc:`Περιγραφή της βιβλιοθήκης σας ώστε να βοηθήσει το κοινό να κατανοήσει τη χρήση της`,githubHandle:`Όνομα χρήστη στο GitHub (προαιρετικό), ώστε να μπορείτε να επεξεργαστείτε τη βιβλιοθήκη αφού υποβληθεί για αξιολόγηση`,twitterHandle:`Όνομα χρήστη Twitter (προαιρετικό), ώστε να γνωρίζουμε σε ποιον/η να δώσουμε εύσημα κατά την προώθηση μέσω Twitter`,website:`Σύνδεσμος για την προσωπική σας ιστοσελίδα ή αλλού (προαιρετικό)`},errors:{required:`Απαιτείται`,website:`Εισάγετε μια έγκυρη διεύθυνση URL`},noteDescription:`Υποβάλετε τη βιβλιοθήκη σας για να συμπεριληφθεί στο <link>δημόσιο αποθετήριο βιβλιοθήκης</link>ώστε να χρησιμοποιηθεί από άλλα άτομα στα σχέδιά τους.`,noteGuidelines:`Η βιβλιοθήκη πρέπει πρώτα να εγκριθεί χειροκίνητα. Παρακαλώ διαβάστε τους <link>οδηγίες</link> πριν την υποβολή. Θα χρειαστείτε έναν λογαριασμό GitHub για την επικοινωνία και για να προβείτε σε αλλαγές εφ' όσον χρειαστεί, αλλά δεν είναι αυστηρή απαίτηση.`,noteLicense:`Με την υποβολή, συμφωνείτε ότι η βιβλιοθήκη θα δημοσιευθεί υπό την <link>Άδεια MIT, </link>που εν συντομία σημαίνει ότι ο καθένας μπορεί να τα χρησιμοποιήσει χωρίς περιορισμούς.`,noteItems:`Κάθε αντικείμενο της βιβλιοθήκης πρέπει να έχει το δικό του όνομα ώστε να μπορεί να φιλτραριστεί. Θα συμπεριληφθούν τα ακόλουθα αντικείμενα βιβλιοθήκης:`,atleastOneLibItem:`Παρακαλώ επιλέξτε τουλάχιστον ένα αντικείμενο βιβλιοθήκης για να ξεκινήσετε`,republishWarning:`Σημείωση: μερικά από τα επιλεγμένα αντικέιμενα έχουν ήδη επισημανθεί ως δημοσιευμένα/υποβεβλημένα. Θα πρέπει να υποβάλετε αντικείμενα εκ νέου μόνο για να ενημερώσετε μία ήδη υπάρχουσα βιβλιοθήκη ή υποβολή.`},g={title:`Η βιβλιοθήκη υποβλήθηκε`,content:`Ευχαριστούμε {{authorName}}. Η βιβλιοθήκη σας έχει υποβληθεί για αξιολόγηση. Μπορείτε να παρακολουθείτε τη διαδικασία<link>εδώ</link>`},_={resetLibrary:`Καθαρισμός βιβλιοθήκης`,removeItemsFromLib:`Αφαίρεση επιλεγμένων αντικειμένων από τη βιβλιοθήκη`},v={header:``,label:{withBackground:``,onlySelected:``,darkMode:``,embedScene:``,scale:``,padding:``},tooltip:{embedScene:``},title:{exportToPng:``,exportToSvg:``,copyPngToClipboard:``},button:{exportToPng:``,exportToSvg:``,copyPngToClipboard:``}},y={tooltip:`Τα σχέδιά σου είναι κρυπτογραφημένα από άκρο σε άκρο, έτσι δεν θα είναι ποτέ ορατά μέσα από τους διακομιστές του Excalidraw.`,link:`Blog post στην κρυπτογράφηση end-to-end στο Excalidraw`},b={angle:`Γωνία`,element:`Στοιχείο`,elements:`Στοιχεία`,height:`Ύψος`,scene:`Σκηνή`,selected:`Επιλεγμένα`,storage:`Χώρος`,title:`Στατιστικά για σπασίκλες`,total:`Σύνολο\xA0`,version:`Έκδοση`,versionCopy:`Κάνε κλικ για αντιγραφή`,versionNotAvailable:`Έκδοση μη διαθέσιμη`,width:`Πλάτος`},x={addedToLibrary:`Προστέθηκε στη βιβλιοθήκη`,copyStyles:`Αντιγράφηκαν στυλ.`,copyToClipboard:`Αντιγράφηκε στο πρόχειρο.`,copyToClipboardAsPng:`Αντιγράφηκε {{exportSelection}} στο πρόχειρο ως PNG
