...
o incollare in un editor di testo esistente`,unableToEmbed:`Incorporare questo url non è permesso. Crea una issue su GitHub per richiedere che l'url sia autorizzato`,unrecognizedLinkFormat:`Il link che hai incorporato non corrisponde al formato previsto. Prova a incollare la stringa 'embed' fornita dal sito di origine`},S={transparent:`Trasparente`,black:`Nero`,white:`Bianco`,red:`Rosso`,pink:`Rosa`,grape:`Uva`,violet:`Viola`,gray:`Grigio`,blue:`Blu`,cyan:`Ciano`,teal:`Verde acqua`,green:`Verde`,yellow:`Giallo`,orange:`Arancio`,bronze:`Bronzo`},C={app:{center_heading:`Tutti i tuoi dati sono salvati localmente nel browser.`,center_heading_plus:`Volevi invece andare su Excalidraw+?`,menuHint:`Esporta, preferenze, lingue, ...`},defaults:{menuHint:`Esporta, preferenze, e altro...`,center_heading:`Diagrammi. Fatto. Semplice.`,toolbarHint:`Scegli uno strumento & Inizia a disegnare!`,helpHint:`Scorciatoie & aiuto`}},w={mostUsedCustomColors:`Colori personalizzati più utilizzati`,colors:`Colori`,shades:`Sfumature`,hexCode:`Codice esadecimale`,noShades:`Nessuna sfumatura disponibile per questo colore`},T={action:{exportToImage:{title:`Esporta come immagine`,button:`Esporta come immagine`,description:`Esporta i dati della scena come immagine, che potrai importare in seguito.`},saveToDisk:{title:`Salva su disco`,button:`Salva su disco`,description:`Esporta i dati della scena su file, che potrai importare in seguito.`},excalidrawPlus:{title:`Excalidraw+`,button:`Esporta su Excalidraw+`,description:`Salva la scena sul tuo spazio di lavoro Excalidraw+.`}},modal:{loadFromFile:{title:`Carica da file`,button:`Carica da file`,description:`Il caricamento da file sostituirà <bold>il contenuto esistente</bold>.<br></br>Puoi salvare il tuo disegno prima usando una delle opzioni qui sotto.`},shareableLink:{title:`Carica da link`,button:`Sostituisci il mio contenuto`,description:`Il caricamento da file sostituirà <bold>il contenuto esistente</bold>.<br></br>Puoi salvare il tuo disegno prima usando una delle opzioni qui sotto.`}}},E={title:``,button:`Inserisci`,description:``,syntax:``,preview:`Anteprima`},D={labels:e,library:t,buttons:n,alerts:r,errors:i,toolBar:a,headings:o,hints:s,canvasError:c,errorSplash:l,roomDialog:u,errorDialog:d,exportDialog:f,helpDialog:p,clearCanvasDialog:m,publishDialog:h,publishSuccessDialog:g,confirmDialog:_,imageExportDialog:v,encrypted:y,stats:b,toast:x,colors:S,welcomeScreen:C,colorPicker:w,overwriteConfirm:T,mermaid:E};export{r as alerts,n as buttons,c as canvasError,m as clearCanvasDialog,w as colorPicker,S as colors,_ as confirmDialog,D as default,y as encrypted,d as errorDialog,l as errorSplash,i as errors,f as exportDialog,o as headings,p as helpDialog,s as hints,v as imageExportDialog,e as labels,t as library,E as mermaid,T as overwriteConfirm,h as publishDialog,g as publishSuccessDialog,u as roomDialog,b as stats,x as toast,a as toolBar,C as welcomeScreen};