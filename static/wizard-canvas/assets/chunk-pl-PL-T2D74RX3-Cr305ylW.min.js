...
lub wklej do istniejącego edytora tekstu`,unableToEmbed:`Osadzenie tego linku jest obecnie niedozwolone. Zgłoś propozycję na portalu GitHub, aby dodać\xA0go do listy dozwolonych wyjątków`,unrecognizedLinkFormat:`Osadzony link ma niewłaściwy format. Spróbuj wkleić całą\xA0zawartość pola "embed" z oryginalnej strony.`},S={transparent:`Przezroczysty`,black:`Czarny`,white:`Biały`,red:`Czerwony`,pink:`Różowy`,grape:`Winogronowy`,violet:`Fioletowy`,gray:`Szary`,blue:`Niebieski`,cyan:`Cyjanowy`,teal:`Turkusowy`,green:`Zielony`,yellow:`Żółty`,orange:`Pomarańczowy`,bronze:`Brązowy`},C={app:{center_heading:`Wszystkie dane są zapisywane lokalnie w przeglądarce.`,center_heading_plus:`Czy zamiast tego chcesz przejść do Excalidraw+?`,menuHint:`Eksportuj, preferencje, języki...`},defaults:{menuHint:`Eksportuj, preferencje i więcej...`,center_heading:`Schematy uproszczone.`,toolbarHint:`Wybierz narzędzie i zacznij rysować!`,helpHint:`Skróty klawiaturowe i pomoc`}},w={mostUsedCustomColors:`Najczęściej używane kolory`,colors:`Kolory`,shades:`Odcienie`,hexCode:`Kod HEX`,noShades:`Brak dostępnych odcieni dla tego koloru`},T={action:{exportToImage:{title:`Eksportuj jako obraz`,button:`Eksportuj jako obraz`,description:`Eksportuj zawartość sceny jako obraz z możliwością\xA0importowania.`},saveToDisk:{title:`Zapisz na dysku`,button:`Zapisz na dysku`,description:`Eksportuj zawartość sceny jako plik z możliwością\xA0importowania.`},excalidrawPlus:{title:`Excalidraw+`,button:`Eksportuj do Excalidraw+`,description:`Zapisz scenę do\xA0swojego obszaru roboczego Excalidraw+.`}},modal:{loadFromFile:{title:`Wczytaj z pliku`,button:`Wczytaj z pliku`,description:`Wczytanie z pliku <bold>nadpisze istniejącą zawartość</bold>.<br></br>Możesz najpierw utworzyć kopię zapasową swojego rysunku, używając jednej z poniższych opcji.`},shareableLink:{title:`Wczytaj z linku`,button:`Nadpisz moją\xA0zawartość`,description:`Wczytanie zewnętrznego pliku <bold>nadpisze istniejącą zawartość</bold>.<br></br>Możesz najpierw utworzyć kopię zapasową swojego rysunku, używając jednej z poniższych opcji.`}}},E={title:`Konwertuj diagram Mermaid do Excalidraw`,button:`Wstaw`,description:`Obecnie wspierane są jedynie <flowchartLink>proste grafy</flowchartLink>, <sequenceLink>sekwencje</sequenceLink> i <classLink>diagramy klas</classLink>. Pozostałe typy będą\xA0wyświetlane jako obrazy w Excalidraw.`,syntax:`Składnia diagramów Mermaid`,preview:`Podgląd`},D={labels:e,library:t,buttons:n,alerts:r,errors:i,toolBar:a,headings:o,hints:s,canvasError:c,errorSplash:l,roomDialog:u,errorDialog:d,exportDialog:f,helpDialog:p,clearCanvasDialog:m,publishDialog:h,publishSuccessDialog:g,confirmDialog:_,imageExportDialog:v,encrypted:y,stats:b,toast:x,colors:S,welcomeScreen:C,colorPicker:w,overwriteConfirm:T,mermaid:E};export{r as alerts,n as buttons,c as canvasError,m as clearCanvasDialog,w as colorPicker,S as colors,_ as confirmDialog,D as default,y as encrypted,d as errorDialog,l as errorSplash,i as errors,f as exportDialog,o as headings,p as helpDialog,s as hints,v as imageExportDialog,e as labels,t as library,E as mermaid,T as overwriteConfirm,h as publishDialog,g as publishSuccessDialog,u as roomDialog,b as stats,x as toast,a as toolBar,C as welcomeScreen};