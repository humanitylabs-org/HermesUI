...
Ваши изменения не будут сохранены!`},i={unsupportedFileType:`Неподдерживаемый тип файла.`,imageInsertError:`Не удалось вставить изображение. Попробуйте позже...`,fileTooBig:`Очень большой файл. Максимально разрешенный размер {{maxSize}}.`,svgImageInsertError:`Не удалось вставить изображение SVG. Разметка SVG выглядит недействительной.`,failedToFetchImage:`Не удалось получить изображение.`,invalidSVGString:`Некорректный SVG.`,cannotResolveCollabServer:`Не удалось подключиться к серверу совместного редактирования. Перезагрузите страницу и повторите попытку.`,importLibraryError:`Не удалось загрузить библиотеку`,collabSaveFailed:`Не удалось сохранить в базу данных. Если проблема повторится, нужно будет сохранить файл локально, чтобы быть уверенным, что вы не потеряете вашу работу.`,collabSaveFailed_sizeExceeded:`Не удалось сохранить в базу данных. Похоже, что холст слишком большой. Нужно сохранить файл локально, чтобы быть уверенным, что вы не потеряете вашу работу.`,imageToolNotSupported:`Изображения отключены.`,brave_measure_text_error:{line1:`Похоже, вы используете браузер Brave с включенной опцией <bold>Агрессивно блокировать отслеживание</bold>.`,line2:`Это может привести к поломке <bold>Текстовых объектов</bold> на рисунке.`,line3:`Мы настоятельно рекомендуем отключить эту настройку. Для этого нужно выполнить <link>эти шаги</link>.`,line4:`Если отключение этой настройки не исправит отображение текстовых объектов, создайте <issueLink>issue</issueLink> на нашем GitHub или напишите нам в <discordLink>Discord</discordLink>`},libraryElementTypeError:{embeddable:``,iframe:`Элементы IFrame не могут быть добавлены в библиотеку.`,image:``},asyncPasteFailedOnRead:`Не удалось вставить (невозможно прочитать из системного буфера обмена).`,asyncPasteFailedOnParse:`Не удалось вставить.`,copyToSystemClipboardFailed:`Не удалось скопировать в буфер обмена.`},a={selection:`Выделение области`,image:`Вставить изображение`,rectangle:`Прямоугольник`,diamond:`Ромб`,ellipse:`Эллипс`,arrow:`Cтрелка`,line:`Линия`,freedraw:`Чертить`,text:`Текст`,library:`Библиотека`,lock:`Сохранять выбранный инструмент активным после рисования`,penMode:`Режим пера - предотвращение касания`,link:`Добавить/обновить ссылку для выбранной фигуры`,eraser:`Ластик`,frame:``,magicframe:``,embeddable:``,laser:`Лазерная указка`,hand:`Рука (перемещение холста)`,extraTools:``,mermaidToExcalidraw:`Из Mermaid в Excalidraw`,magicSettings:`Параметры AI`},o={canvasActions:`Операции холста`,selectedShapeActions:`Операции выбранной фигуры`,shapes:`Фигуры`},s={canvasPanning:`Чтобы двигать холст, удерживайте колесо мыши или пробел во время перетаскивания, или используйте инструмент "Рука"`,linearElement:`Нажмите, чтобы начать несколько точек, перетащите для одной линии`,freeDraw:`Нажмите и перетаскивайте, отпустите по завершении`,text:`Совет: при выбранном инструменте выделения дважды щёлкните в любом месте, чтобы добавить текст`,embeddable:``,text_selected:`Дважды щелкните мышью или нажмите ENTER, чтобы редактировать текст`,text_editing:`Нажмите Escape либо Ctrl или Cmd + ENTER для завершения редактирования`,linearElementMulti:`Кликните на последней точке или нажмите Escape или Enter чтобы закончить`,lockAngle:`Вы можете ограничить угол удерживая SHIFT`,resize:`Вы можете ограничить пропорции, удерживая SHIFT во время изменения размеров,
