...
o enganxeu-lo en un editor de text existent`,unableToEmbed:``,unrecognizedLinkFormat:``},S={transparent:`Transparent`,black:``,white:``,red:``,pink:``,grape:``,violet:``,gray:``,blue:``,cyan:``,teal:``,green:`Verd`,yellow:`Groc`,orange:`Taronja`,bronze:`Bronze`},C={app:{center_heading:`Totes les vostres dades es guarden localment al vostre navegador.`,center_heading_plus:`Vols anar a Excalidraw+ en comptes?`,menuHint:`Exportar, preferències, llenguatges...`},defaults:{menuHint:`Exportar, preferències i més...`,center_heading:`Diagrames. Fer. Simple.`,toolbarHint:`Selecciona una eina i comença a dibuixar!`,helpHint:`Dreceres i ajuda`}},w={mostUsedCustomColors:``,colors:``,shades:``,hexCode:``,noShades:``},T={action:{exportToImage:{title:`Exporta com a imatge`,button:`Exporta com a imatge`,description:``},saveToDisk:{title:`Desa al disc`,button:`Desa al disc`,description:``},excalidrawPlus:{title:``,button:``,description:``}},modal:{loadFromFile:{title:`Carrega des d'un fitxer`,button:`Carrega des d'un fitxer`,description:``},shareableLink:{title:`Carrega des d'un enllaç`,button:``,description:``}}},E={title:`De Mermaid a Excalidraw`,button:`Insereix`,description:``,syntax:`Sintaxi de Mermaid`,preview:`Previsualització`},D={labels:e,library:t,buttons:n,alerts:r,errors:i,toolBar:a,headings:o,hints:s,canvasError:c,errorSplash:l,roomDialog:u,errorDialog:d,exportDialog:f,helpDialog:p,clearCanvasDialog:m,publishDialog:h,publishSuccessDialog:g,confirmDialog:_,imageExportDialog:v,encrypted:y,stats:b,toast:x,colors:S,welcomeScreen:C,colorPicker:w,overwriteConfirm:T,mermaid:E};export{r as alerts,n as buttons,c as canvasError,m as clearCanvasDialog,w as colorPicker,S as colors,_ as confirmDialog,D as default,y as encrypted,d as errorDialog,l as errorSplash,i as errors,f as exportDialog,o as headings,p as helpDialog,s as hints,v as imageExportDialog,e as labels,t as library,E as mermaid,T as overwriteConfirm,h as publishDialog,g as publishSuccessDialog,u as roomDialog,b as stats,x as toast,a as toolBar,C as welcomeScreen};