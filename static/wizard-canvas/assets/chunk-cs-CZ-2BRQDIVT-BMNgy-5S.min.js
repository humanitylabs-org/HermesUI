...
nebo vložte do existujícího textového editoru`,unableToEmbed:``,unrecognizedLinkFormat:``},S={transparent:`Průhledná`,black:`Černá`,white:`Bílá`,red:`Červená`,pink:`Růžová`,grape:`Vínová`,violet:`Fialová`,gray:`Šedá`,blue:`Modrá`,cyan:`Azurová`,teal:`Modrozelená`,green:`Zelená`,yellow:`Žlutá`,orange:`Oranžová`,bronze:`Bronzová`},C={app:{center_heading:`Všechna vaše data jsou uložena lokálně ve vašem prohlížeči.`,center_heading_plus:`Chcete místo toho přejít na Excalidraw+?`,menuHint:`Export, nastavení, jazyky, ...`},defaults:{menuHint:`Export, nastavení a další...`,center_heading:`Diagramy. Vytvořeny. Jednoduše.`,toolbarHint:`Vyberte nástroj a začněte kreslit!`,helpHint:`Zkratky a pomoc`}},w={mostUsedCustomColors:`Nejpoužívanější vlastní barvy`,colors:`Barvy`,shades:`Stíny`,hexCode:`Hex kód`,noShades:`Pro tuto barvu nejsou k dispozici žádné odstíny`},T={action:{exportToImage:{title:``,button:``,description:``},saveToDisk:{title:``,button:``,description:``},excalidrawPlus:{title:``,button:``,description:``}},modal:{loadFromFile:{title:``,button:``,description:``},shareableLink:{title:``,button:``,description:``}}},E={title:``,button:``,description:``,syntax:``,preview:``},D={labels:e,library:t,buttons:n,alerts:r,errors:i,toolBar:a,headings:o,hints:s,canvasError:c,errorSplash:l,roomDialog:u,errorDialog:d,exportDialog:f,helpDialog:p,clearCanvasDialog:m,publishDialog:h,publishSuccessDialog:g,confirmDialog:_,imageExportDialog:v,encrypted:y,stats:b,toast:x,colors:S,welcomeScreen:C,colorPicker:w,overwriteConfirm:T,mermaid:E};export{r as alerts,n as buttons,c as canvasError,m as clearCanvasDialog,w as colorPicker,S as colors,_ as confirmDialog,D as default,y as encrypted,d as errorDialog,l as errorSplash,i as errors,f as exportDialog,o as headings,p as helpDialog,s as hints,v as imageExportDialog,e as labels,t as library,E as mermaid,T as overwriteConfirm,h as publishDialog,g as publishSuccessDialog,u as roomDialog,b as stats,x as toast,a as toolBar,C as welcomeScreen};