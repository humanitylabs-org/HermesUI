import{C as e,S as t,g as n,n as r,o as i,t as a,u as o,w as s,x as c}from"./chunk-chunk-FOHPRMQF-BPzUcG4Q.min.js";var l=class extends a{static{c(this,`RailroadTokenBuilder`)}constructor(){super([`railroad-beta`])}},u=c(e=>{let t=e.slice(1,-1),n=``;for(let e=0;e<t.length;e++){let r=t[e];if(r===`\\`&&e+1<t.length){e++;let r=t[e];switch(r){case`n`:n+=`
