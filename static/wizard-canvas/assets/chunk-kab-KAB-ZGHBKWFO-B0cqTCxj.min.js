...
neɣ ṭṭef Alt akken ad ternuḍ tinqiḍin timaynutin`,placeImage:`Ssit akken ad tserseḍ tugna, neɣ ssit u zuɣer akken ad tesbaduḍ tiddi-ines s ufus`,publishLibrary:`Siẓreg tamkarḍit-inek•inem`,bindTextToElement:`Ssed ɣef kcem akken ad ternuḍ aḍris`,deepBoxSelect:`Ṭṭef CtrlOrCmd akken ad tferneḍ s telqey, yerna ad trewleḍ i uzuɣer`,eraserRevert:`Ssed Alt akken ad tsefsxeḍ iferdisen yettwacerḍen i tukksa`,firefox_clipboard_write:``,disableSnapping:``},c={cannotShowPreview:`Ulamek abeqqeḍ n teskant`,canvasTooBig:`Taɣzut n usuneɣ tezmer ad tili temeqqer aṭas.`,canvasTooBigTip:`Tixidest: eɛreḍ ad tesqerbeḍ ciṭ iferdisen yembaɛaden.`},l={headingMain:`Teḍra-d tuccḍa. Eɛreḍ <button>asali n usebter tikkelt-nniḍen.</button>`,clearCanvasMessage:`Ma yella tulsa n usali ur tefri ara ugur, eɛreḍ <button>asfaḍ n teɣzut n usuneɣ.</button>`,clearCanvasCaveat:` Ayagi ad d-iglu s usṛuḥu n umahil `,trackedToSentry:`Tuccḍa akked umesmagi {{eventId}} tettwasekles deg unagraw-nneɣ.`,openIssueMessage:`Nḥuder aṭas akken ur nseddu ara talɣut n usayes-inek (m) di tuccḍa. Ma yella asayes-inek (m) mačči d amaẓlay, ttxil-k (m) xemmem ad ḍefreḍ <button>afecku n weḍfar n yibugen.</button> Ma ulac uɣilif seddu talɣut ukessar-agi s wenɣal akked usenṭeḍ di GitHub issue.`,sceneContent:`Agbur n usayes:`},u={desc_intro:`Tzemreḍ ad d-teɛerḍeḍ medden ɣer usayes-inek (m) amiran akken ad ttekkin yid-k.`,desc_privacy:`Ur tqelliq ara, tiɣimit tsseqdac awgelhen ixef s ixef, dɣa ayen ara tsunɣeḍ ad iqqim d amaẓlay. Ula d aqeddac-nneɣ ur yezmir ara ad iwali acu txeddemeḍ.`,button_startSession:`Bdu tiɣimit`,button_stopSession:`Ḥbes tiɣimit`,desc_inProgressIntro:`Tiɣimit n umɛawen s srid tetteddu akka tura.`,desc_shareLink:`Bḍu aseɣwen-agi akked medden ukud tebɣiḍ ad temɛawaneḍ:`,desc_exitSession:`Aḥbas n tɣimit ad k (m) yesenser si texxamt, maca ad tizmireḍ ad tkemmeleḍ amahil s usayes, s wudem adigan. Ẓer belli ayagi ur yettḥaz ara imdanen-nniḍen, yerna ad izmiren ad kemmelen ad mɛawanen di tsuffeɣt-nnsen.`,shareTitle:`Rnu ɣer tɣimit n umɛiwen s srid n Excalidraw`},d={title:`Tuccḍa`},f={disk_title:`Sekles deg uḍebsi`,disk_details:`Sekles isefka n usayes deg ufaylu ansi ara tizmireḍ ad d-tketreḍ areḍqal.`,disk_button:`Sekles deg ufaylu`,link_title:`Aseɣwen n beṭṭu`,link_details:`Sifeḍ am useɣwen n tɣuri kan.`,link_button:`Sifeḍ deg useɣwen`,excalidrawplus_description:`Sekles asayes-inek•inem di tallunt n umahil Excalidraw+.`,excalidrawplus_button:`Sifeḍ`,excalidrawplus_exportError:`Ulamek asifeḍ ɣer Excalidraw+ akka tura...`},p={blog:`Ɣeṛ ablug-nneɣ`,click:`ssit`,deepSelect:`Afran s telqey`,deepBoxSelect:`Afran s telqey s tnaka, yerna ad tyrewleḍ i uzuɣer`,curvedArrow:`Taneccabt izelgen`,curvedLine:`Izirig izelgen`,documentation:`Tasemlit`,doubleClick:`ssit snat n tikkal`,drag:`zuɣer`,editor:`Amaẓrag`,editLineArrowPoints:`Ẓreg tinqiḍin n yizirig/taneccabt`,editText:`Ẓreg aḍris/rnu tabzimt`,github:`Tufiḍ-d ugur? Azen-aɣ-d`,howto:`Ḍfer imniren-nneɣ`,or:`neɣ`,preventBinding:`Seḥbes tuqqna n tneccabin`,tools:`Ifecka`,shortcuts:`Inegzumen n unasiw`,textFinish:`Fak asiẓreg (amaẓrag n uḍris)`,textNewLine:`Rnu ajerriḍ amaynut (amaẓrag n uḍris)`,title:`Tallelt`,view:`Tamuɣli`,zoomToFit:`Simɣur akken ad twliḍ akk iferdisen`,zoomToSelection:`Simɣur ɣer tefrayt`,toggleElementLock:`Sekkeṛ/kkes asekker i tefrayt`,movePageUpDown:`Smutti asebter d asawen/akessar`,movePageLeftRight:`Smutti asebter s azelmaḍ/ayfus`},m={title:`Sfeḍ taɣzut n usuneɣ`},h={title:`Suffeɣ-d tamkarḍit`,itemName:`Isem n uferdis`,authorName:`Isem n umeskar`,githubUsername:`Isem n useqdac n GitHub`,twitterUsername:`Isem n useqdac n Twitter`,libraryName:`Isem n temkarḍit`,libraryDesc:`Aglam n temkarḍit`,website:`Asmel n web`,placeholder:{authorName:`Isem neɣ isem n useqdac inek•inem`,libraryName:`Isem n temkarḍit-inek•inem`,libraryDesc:`Aglam n temkarḍit-inek•inem akken ad tɛiwneḍ medden ad fehmen aseqdec-inec`,githubHandle:`Isem n useqdac n GitHub ( d anefrunan) akken ad tizmireḍ ad tisẓrigeḍ tamkarḍit ticki tuzneḍ-tt i uselken`,twitterHandle:`Isem n useqdac n Twitter (d anefrunan) akken ad nẓer anwa ara nsenmer deg udellel di Twitter`,website:`Aseɣwen ɣer usmel-inek•inem neɣ wayeḍ (d anefrunan)`},errors:{required:`Yettwasra`,website:`Sekcem URL ameɣtu`},noteDescription:`Azen tamkarḍit-inek•inem akken ad teddu di <link>akaram azayez n temkarḍit</link>i yimdanen-nniḍen ara isqedcen deg wunuɣen-nnsen.`,noteGuidelines:`Tamkarḍit teḥwaǧ ad tettwaqbel s ufus qbel. Ma ulac uɣilif ɣer <link>iwellihen</link> send ad tazneḍ. Tesriḍ amiḍan n GitHub akken ad tmmeslayeḍ yerna ad tgeḍ ibeddilen ma yelaq, maca mačči d ayen yettwaḥetmen.`,noteLicense:`Mi tuzneḍ ad tqebleḍ akken tamkarḍit ad d-teffeɣ s <link>Turagt MIT, </link>ayen yebɣan ad d-yini belli yal yiwen izmer ad ten-iseqdec war tilist.`,noteItems:`Yal aferdis n temkarḍit isefk ad isɛu isem-is i yiman-is akken ad yili wamek ara yettusizdeg. Iferdisen-agi n temkarḍit ad ddun:`,atleastOneLibItem:`Ma ulac uɣilif fern ma drus yiwen n uferdis n temkarḍit akken ad tebduḍ`,republishWarning:`Tamawt: kra n yiferdisen yettwafernen ttwacerḍen ffeɣen-d/ttwaznen. Isefk ad talseḍ tuzzna n yiferdisen anagar mi ara tleqqemeḍ tamkarḍit neɣ tuzzna yellan.`},g={title:`Tamkarḍit tettwazen`,content:`Tanemmirt-ik•im {{authorName}}. Tamkarḍit-inek•inem tettwazen i weselken. Tzemreḍ ad tḍefreḍ aẓayer<link>dagi</link>`},_={resetLibrary:`Ales awennez n temkarḍit`,removeItemsFromLib:`Kkes iferdisen yettafernen si temkarḍit`},v={header:``,label:{withBackground:``,onlySelected:``,darkMode:``,embedScene:``,scale:``,padding:``},tooltip:{embedScene:``},title:{exportToPng:``,exportToSvg:``,copyPngToClipboard:``},button:{exportToPng:``,exportToSvg:``,copyPngToClipboard:``}},y={tooltip:`Unuɣen-inek (m) ttuwgelhnen seg yixef s ixef dɣa iqeddacen n Excalidraw werǧin ad ten-walin. `,link:`Amagrad ɣef uwgelhen ixef s ixef di Excalidraw`},b={angle:`Tiɣmeṛt`,element:`Aferdis`,elements:`Iferdisen`,height:`Tattayt`,scene:`Asayes`,selected:`Yettwafren`,storage:`Aḥraz`,title:``,total:`Aɣrud`,version:`Alqem`,versionCopy:`Sit ad tneɣleḍ`,versionNotAvailable:`Ur inuḥ ulqem`,width:`Tehri`},x={addedToLibrary:`Yettwarna ɣer temkarḍit`,copyStyles:`Iɣunab yettwaneɣlen.`,copyToClipboard:`Yettwaɣel ɣer tecfawit.`,copyToClipboardAsPng:`{{exportSelection}} yettwanɣel ɣer tecfawit am PNG
({{exportColorScheme}})`,fileSaved:`Afaylu yettwasekles.`,fileSavedToFilename:`Yettwasekles di {filename}`,canvas:`taɣzut n usuneɣ`,selection:`tafrayt`,pasteAsSingleElement:``,unableToEmbed:``,unrecognizedLinkFormat:``},S={transparent:`Afrawan`,black:``,white:``,red:``,pink:``,grape:``,violet:``,gray:``,blue:``,cyan:``,teal:``,green:``,yellow:``,orange:``,bronze:``},C={app:{center_heading:`Akk isefka-inek•inem ttwakelsen s wudem adigan deg yiminig-inek•inem.`,center_heading_plus:`Tebɣiḍ ad tedduḍ ɣer Excalidraw+ deg umḍiq?`,menuHint:`Asifeḍ, ismenyifen, tutlayin, ...`},defaults:{menuHint:`Asifeḍ, ismenyifen, d wayen-nniḍen...`,center_heading:``,toolbarHint:`Fren afecku tebduḍ asuneɣ!`,helpHint:`Inegzumen akked tallelt`}},w={mostUsedCustomColors:``,colors:``,shades:``,hexCode:``,noShades:``},T={action:{exportToImage:{title:``,button:``,description:``},saveToDisk:{title:``,button:``,description:``},excalidrawPlus:{title:``,button:``,description:``}},modal:{loadFromFile:{title:``,button:``,description:``},shareableLink:{title:``,button:``,description:``}}},E={title:``,button:``,description:``,syntax:``,preview:``},D={labels:e,library:t,buttons:n,alerts:r,errors:i,toolBar:a,headings:o,hints:s,canvasError:c,errorSplash:l,roomDialog:u,errorDialog:d,exportDialog:f,helpDialog:p,clearCanvasDialog:m,publishDialog:h,publishSuccessDialog:g,confirmDialog:_,imageExportDialog:v,encrypted:y,stats:b,toast:x,colors:S,welcomeScreen:C,colorPicker:w,overwriteConfirm:T,mermaid:E};export{r as alerts,n as buttons,c as canvasError,m as clearCanvasDialog,w as colorPicker,S as colors,_ as confirmDialog,D as default,y as encrypted,d as errorDialog,l as errorSplash,i as errors,f as exportDialog,o as headings,p as helpDialog,s as hints,v as imageExportDialog,e as labels,t as library,E as mermaid,T as overwriteConfirm,h as publishDialog,g as publishSuccessDialog,u as roomDialog,b as stats,x as toast,a as toolBar,C as welcomeScreen};