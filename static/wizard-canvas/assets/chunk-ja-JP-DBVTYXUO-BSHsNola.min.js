...
既存のテキストエディタに貼り付け`,unableToEmbed:``,unrecognizedLinkFormat:``},S={transparent:`透明`,black:`黒`,white:`白`,red:`赤`,pink:`ピンク`,grape:`グレープ`,violet:`バイオレット`,gray:`灰色`,blue:`青`,cyan:`シアン`,teal:`ティール`,green:`緑`,yellow:`黄`,orange:`オレンジ`,bronze:`ブロンズ`},C={app:{center_heading:`すべてのデータはブラウザにローカル保存されます。`,center_heading_plus:`代わりにExcalidraw+を開きますか？`,menuHint:`エクスポート、設定、言語...`},defaults:{menuHint:`エクスポート、設定、その他...`,center_heading:`ダイアグラムを簡単に。`,toolbarHint:`ツールを選んで描き始めよう！`,helpHint:`ショートカットとヘルプ`}},w={mostUsedCustomColors:`最も使用されているカスタム色`,colors:`色`,shades:`影`,hexCode:`Hexコード`,noShades:``},T={action:{exportToImage:{title:`画像としてエクスポート`,button:`画像としてエクスポート`,description:``},saveToDisk:{title:`ディスクに保存`,button:`ディスクに保存`,description:``},excalidrawPlus:{title:`Excalidraw+`,button:`Excalidraw+にエクスポート`,description:`Excalidraw+ ワークスペースにシーンを保存します。`}},modal:{loadFromFile:{title:`ファイルからロード`,button:`ファイルからロード`,description:``},shareableLink:{title:`リンクからロード`,button:``,description:``}}},E={title:``,button:``,description:``,syntax:``,preview:``},D={labels:e,library:t,buttons:n,alerts:r,errors:i,toolBar:a,headings:o,hints:s,canvasError:c,errorSplash:l,roomDialog:u,errorDialog:d,exportDialog:f,helpDialog:p,clearCanvasDialog:m,publishDialog:h,publishSuccessDialog:g,confirmDialog:_,imageExportDialog:v,encrypted:y,stats:b,toast:x,colors:S,welcomeScreen:C,colorPicker:w,overwriteConfirm:T,mermaid:E};export{r as alerts,n as buttons,c as canvasError,m as clearCanvasDialog,w as colorPicker,S as colors,_ as confirmDialog,D as default,y as encrypted,d as errorDialog,l as errorSplash,i as errors,f as exportDialog,o as headings,p as helpDialog,s as hints,v as imageExportDialog,e as labels,t as library,E as mermaid,T as overwriteConfirm,h as publishDialog,g as publishSuccessDialog,u as roomDialog,b as stats,x as toast,a as toolBar,C as welcomeScreen};