...
o pegar en un editor de texto existente`,unableToEmbed:``,unrecognizedLinkFormat:``},S={transparent:`Transparente`,black:`Negro`,white:`Blanco`,red:`Rojo`,pink:`Rosa`,grape:`Uva`,violet:`Violeta`,gray:`Gris`,blue:`Azul`,cyan:`Cian`,teal:`Turquesa`,green:`Verde`,yellow:`Amarillo`,orange:`Naranja`,bronze:`Bronce`},C={app:{center_heading:`Toda su información es guardada localmente en su navegador.`,center_heading_plus:`¿Quieres ir a Excalidraw+?`,menuHint:`Exportar, preferencias, idiomas, ...`},defaults:{menuHint:`Exportar, preferencias y más...`,center_heading:`Diagramas. Hecho. Simplemente.`,toolbarHint:`¡Elige una herramienta y empieza a dibujar!`,helpHint:`Atajos y ayuda`}},w={mostUsedCustomColors:`Colores personalizados más utilizados`,colors:`Colores`,shades:``,hexCode:`Código Hexadecimal`,noShades:``},T={action:{exportToImage:{title:`Exportar como imagen`,button:`Exportar como imagen`,description:``},saveToDisk:{title:`Guardar en el disco`,button:`Guardar en el disco`,description:`Exporta los datos de la escena a un archivo desde el cual podrás importar más tarde.`},excalidrawPlus:{title:``,button:`Exportar a Excalidraw+`,description:``}},modal:{loadFromFile:{title:`Cargar desde un archivo`,button:`Cargar desde un archivo`,description:``},shareableLink:{title:`Cargar desde un enlace`,button:`Reemplazar mi contenido`,description:`Cargar un dibujo externo <bold>reemplazará tu contenido existente</bold>.<br></br>Puedes primero hacer una copia de seguridad de tu dibujo usando una de las opciones de abajo.`}}},E={title:`Mermaid a Excalidraw`,button:`Insertar`,description:`Actualmente sólo <flowchartLink>Flowchart</flowchartLink>,<sequenceLink> Secuencia, </sequenceLink> y <classLink>Class </classLink>Diagramas son soportados. Los otros tipos se renderizarán como imagen en Excalidraw.`,syntax:`Sintaxis Mermaid`,preview:`Vista previa`},D={labels:e,library:t,buttons:n,alerts:r,errors:i,toolBar:a,headings:o,hints:s,canvasError:c,errorSplash:l,roomDialog:u,errorDialog:d,exportDialog:f,helpDialog:p,clearCanvasDialog:m,publishDialog:h,publishSuccessDialog:g,confirmDialog:_,imageExportDialog:v,encrypted:y,stats:b,toast:x,colors:S,welcomeScreen:C,colorPicker:w,overwriteConfirm:T,mermaid:E};export{r as alerts,n as buttons,c as canvasError,m as clearCanvasDialog,w as colorPicker,S as colors,_ as confirmDialog,D as default,y as encrypted,d as errorDialog,l as errorSplash,i as errors,f as exportDialog,o as headings,p as helpDialog,s as hints,v as imageExportDialog,e as labels,t as library,E as mermaid,T as overwriteConfirm,h as publishDialog,g as publishSuccessDialog,u as roomDialog,b as stats,x as toast,a as toolBar,C as welcomeScreen};