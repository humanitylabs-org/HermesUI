...
یا Alt را نگه دارید و برای افزودن نقاط جدید کلیک کنید`,placeImage:`برای قرار دادن تصویر کلیک کنید، یا کلیک کنید و بکشید تا اندازه آن به صورت دستی تنظیم شود`,publishLibrary:`کتابخانه خود را منتشر کنید`,bindTextToElement:`برای افزودن اینتر را بزنید`,deepBoxSelect:`CtrlOrCmd را برای انتخاب عمیق و جلوگیری از کشیدن نگه دارید`,eraserRevert:`Alt را نگه دارید تا عناصر علامت گذاری شده برای حذف برگردند`,firefox_clipboard_write:`احتمالاً می‌توان این ویژگی را با تنظیم پرچم «dom.events.asyncClipboard.clipboardItem» روی «true» فعال کرد. برای تغییر پرچم های مرورگر در فایرفاکس، از صفحه "about:config" دیدن کنید.`,disableSnapping:``},c={cannotShowPreview:`پیش نمایش نشان داده نمی شود`,canvasTooBig:`بوم نقاشی بسیار بزرگ است.`,canvasTooBigTip:`نکته: سعی کنید دورترین عناصر را کمی به همدیگر نزدیک کنید.`},l={headingMain:``,clearCanvasMessage:`اگر بازنشانی صفحه مشکل را حل نکرد این را امتحان کنید `,clearCanvasCaveat:` این باعث میشود کارهای شما ذخیره نشود `,trackedToSentry:``,openIssueMessage:``,sceneContent:`محتوای صحنه:`},u={desc_intro:`می توانید افرادی را به صحنه فعلی خود دعوت کنید تا با شما همکاری کنند.`,desc_privacy:`نگران نباشید، این جلسه از رمزگذاری دوطرفه استفاده می کند، پس هر چیزی بکشید خصوصی خواهد ماند. حتی سرور ما نمیتواند ببیند چیزی که شما طراحی میکنید.`,button_startSession:`شروع جلسه`,button_stopSession:`پایان جلسه`,desc_inProgressIntro:`جلسه همکاری آنلاین در حال انجام است.`,desc_shareLink:`این لینک را با هر کسی که می خواهید با او همکاری کنید به اشتراک بگذارید:`,desc_exitSession:`با پایان دادن جلسه، شما از اتاق حذف میکند، اما می توانید به صورت محلی کار خود را با بوم ادامه دهید. توجه داشته باشید که این مورد بر سایر افراد تأثیر نمی گذارد و همچنان می توانند در نسخه خود همکاری کنند.`,shareTitle:`به یک جلسه همکاری زنده در Excalidraw بپیوندید`},d={title:`خطا`},f={disk_title:`ذخیره در دیسک`,disk_details:`داده های صحنه را به فایلی که بعداً می توانید از آن وارد کنید صادر کنید.`,disk_button:`ذخیره در فایل`,link_title:`لینک قابل اشتراک‌گذاری`,link_details:`خروجی به عنوان یک پیوند فقط خواندنی.`,link_button:`خروجی در فایل`,excalidrawplus_description:`صحنه را در فضای کاری Excalidraw+ خود ذخیره کنید.`,excalidrawplus_button:`خروجی گرفتن`,excalidrawplus_exportError:`در حال حاضر نمی‌توان به Excalidraw+ صادر کرد...`},p={blog:`بلاگ ما را بخوانید`,click:`کلیک`,deepSelect:`انتخاب عمیق`,deepBoxSelect:`انتخاب عمیق در کادر، و جلوگیری از کشیدن`,curvedArrow:`فلش خمیده`,curvedLine:`منحنی`,documentation:`مستندات`,doubleClick:`دابل کلیک`,drag:`کشیدن`,editor:`ویرایشگر`,editLineArrowPoints:`نقاط خط/پیکان را ویرایش کنید`,editText:`ویرایش متن / افزودن برچسب`,github:`اشکالی می بینید؟ گزارش دهید`,howto:`راهنمای ما را دنبال کنید`,or:`یا`,preventBinding:`مانع شدن از چسبیدن فلش ها`,tools:`ابزار`,shortcuts:`میانبرهای صفحه کلید`,textFinish:`پایان ویرایش (ویرایشگر متن)`,textNewLine:`افزودن خط جدید (ویرایشگر متن)`,title:`راهنما`,view:`مشاهده`,zoomToFit:`بزرگنمایی برای دیدن تمام آیتم ها`,zoomToSelection:`بزرگنمایی قسمت انتخاب شده`,toggleElementLock:`قفل/بازکردن انتخاب شده ها`,movePageUpDown:`حرکت صفحه به بالا/پایین`,movePageLeftRight:`حرکت صفحه به چپ/راست`},m={title:`پاک کردن بوم`},h={title:`انتشار کتابخانه`,itemName:`نام آیتم`,authorName:`نام نویسنده`,githubUsername:`نام کاربری گیت هاب`,twitterUsername:`نام کاربری توییتر`,libraryName:`نام کتابخانه`,libraryDesc:`توضیحات کتابخانه`,website:`تارنما`,placeholder:{authorName:`نام یا نام کاربری شما`,libraryName:`اسم کتابخانه`,libraryDesc:`شرحی از کتابخانه شما برای کمک به مردم برای درک استفاده از آن`,githubHandle:`دسته GitHub (اختیاری)، بنابراین می توانید پس از ارسال برای بررسی، کتابخانه را ویرایش کنید`,twitterHandle:`نام کاربری توییتر (اختیاری)، بنابراین می دانیم هنگام تبلیغ در توییتر به چه کسی اعتبار دهیم`,website:`پیوند به وب سایت شخصی شما یا هر جای دیگر (اختیاری)`},errors:{required:`لازم`,website:`وارد کردن آدرس درست`},noteDescription:``,noteGuidelines:``,noteLicense:``,noteItems:`هر مورد کتابخانه باید نام خاص خود را داشته باشد تا قابل فیلتر باشد. اقلام کتابخانه زیر شامل خواهد شد:`,atleastOneLibItem:`لطفاً حداقل یک مورد از کتابخانه را برای شروع انتخاب کنید`,republishWarning:`توجه: برخی از موارد انتخاب شده به عنوان قبلاً منتشر شده/ارسال شده علامت گذاری شده اند. شما فقط باید هنگام به‌روزرسانی یک کتابخانه موجود یا ارسال، موارد را دوباره ارسال کنید.`},g={title:`کتابخانه ارسال شد`,content:`تشکر از شما {{authorName}}. کتابخانه شما برای بررسی ارسال شده است. می توانید وضعیت را پیگیری کنید`},_={resetLibrary:`تنظیم مجدد کتابخانه`,removeItemsFromLib:`موارد انتخاب شده از موارد پسندیده حذف شوند`},v={header:``,label:{withBackground:`پس زمینه`,onlySelected:``,darkMode:`حالت تیره`,embedScene:``,scale:``,padding:``},tooltip:{embedScene:``},title:{exportToPng:``,exportToSvg:``,copyPngToClipboard:``},button:{exportToPng:`PNG`,exportToSvg:`SVG`,copyPngToClipboard:`کپی در کلیپ‌بورد`}},y={tooltip:`شما در یک محیط رمزگزاری شده دو طرفه در حال طراحی هستید پس Excalidraw هرگز طرح های شما را نمیبند.`,link:`پست وبلاگ در مورد رمزگذاری سرتاسر در Excalidraw`},b={angle:`زاویه`,element:`اِلمان`,elements:`اِلمان ها`,height:`ارتفاع`,scene:`صحنه`,selected:`انتخاب شده`,storage:`حافظه`,title:`آمار برای نردها`,total:`مجموع`,version:`نسخه`,versionCopy:`برای کپی کردن کلیک کنید`,versionNotAvailable:`نسخه غیرقابل دسترس`,width:`عرض`},x={addedToLibrary:`به مجموعه اضافه شد`,copyStyles:`کپی سبک.`,copyToClipboard:`در کلیپ‌بورد کپی شد.`,copyToClipboardAsPng:`کپی {{exportSelection}} در کلیپبورد به عنوان PNG
