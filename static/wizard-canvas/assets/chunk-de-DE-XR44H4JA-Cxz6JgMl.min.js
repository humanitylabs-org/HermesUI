...
einzufügen oder in einen existierenden Texteditor einzufügen`,unableToEmbed:`Einbetten dieser URL ist derzeit nicht zulässig. Erstelle einen Issue auf GitHub, um die URL freigeben zu lassen`,unrecognizedLinkFormat:`Der Link, den Du eingebettet hast, stimmt nicht mit dem erwarteten Format überein. Bitte versuche den 'embed' String einzufügen, der von der Quellseite zur Verfügung gestellt wird`},S={transparent:`Transparent`,black:`Schwarz`,white:`Weiß`,red:`Rot`,pink:`Pink`,grape:`Traube`,violet:`Violett`,gray:`Grau`,blue:`Blau`,cyan:`Cyan`,teal:`Blaugrün`,green:`Grün`,yellow:`Gelb`,orange:`Orange`,bronze:`Bronze`},C={app:{center_heading:`Alle Daten werden lokal in Deinem Browser gespeichert.`,center_heading_plus:`Möchtest du stattdessen zu Excalidraw+ gehen?`,menuHint:`Exportieren, Einstellungen, Sprachen, ...`},defaults:{menuHint:`Exportieren, Einstellungen und mehr...`,center_heading:`Diagramme. Einfach. Gemacht.`,toolbarHint:`Wähle ein Werkzeug & beginne zu zeichnen!`,helpHint:`Kurzbefehle & Hilfe`}},w={mostUsedCustomColors:`Beliebteste benutzerdefinierte Farben`,colors:`Farben`,shades:`Schattierungen`,hexCode:`Hex-Code`,noShades:`Keine Schattierungen für diese Farbe verfügbar`},T={action:{exportToImage:{title:`Als Bild exportieren`,button:`Als Bild exportieren`,description:`Exportiere die Zeichnungsdaten als ein Bild, von dem Du später importieren kannst.`},saveToDisk:{title:`Auf Festplatte speichern`,button:`Auf Festplatte speichern`,description:`Exportiere die Zeichnungsdaten in eine Datei, von der Du später importieren kannst.`},excalidrawPlus:{title:`Excalidraw+`,button:`Export nach Excalidraw+`,description:`Speichere die Szene in deinem Excalidraw+-Arbeitsbereich.`}},modal:{loadFromFile:{title:`Aus Datei laden`,button:`Aus Datei laden`,description:`Das Laden aus einer Datei wird <bold>Deinen vorhandenen Inhalt ersetzen</bold>.<br></br>Du kannst Deine Zeichnung zuerst mit einer der folgenden Optionen sichern.`},shareableLink:{title:`Aus Link laden`,button:`Meinen Inhalt ersetzen`,description:`Das Laden einer externen Zeichnung wird <bold>Deinen vorhandenen Inhalt ersetzen</bold>.<br></br>Du kannst Deine Zeichnung zuerst mit einer der folgenden Optionen sichern.`}}},E={title:`Mermaid zu Excalidraw`,button:`Einfügen`,description:`Derzeit werden nur <flowchartLink>Flussdiagramme</flowchartLink>, <sequenceLink>Sequenzdiagramme</sequenceLink> und <classLink>Klassendiagramme</classLink> unterstützt. Die anderen Typen werden als Bild in Excalidraw dargestellt.`,syntax:`Mermaid-Syntax`,preview:`Vorschau`},D={labels:e,library:t,buttons:n,alerts:r,errors:i,toolBar:a,headings:o,hints:s,canvasError:c,errorSplash:l,roomDialog:u,errorDialog:d,exportDialog:f,helpDialog:p,clearCanvasDialog:m,publishDialog:h,publishSuccessDialog:g,confirmDialog:_,imageExportDialog:v,encrypted:y,stats:b,toast:x,colors:S,welcomeScreen:C,colorPicker:w,overwriteConfirm:T,mermaid:E};export{r as alerts,n as buttons,c as canvasError,m as clearCanvasDialog,w as colorPicker,S as colors,_ as confirmDialog,D as default,y as encrypted,d as errorDialog,l as errorSplash,i as errors,f as exportDialog,o as headings,p as helpDialog,s as hints,v as imageExportDialog,e as labels,t as library,E as mermaid,T as overwriteConfirm,h as publishDialog,g as publishSuccessDialog,u as roomDialog,b as stats,x as toast,a as toolBar,C as welcomeScreen};